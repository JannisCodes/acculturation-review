...
\subsection{Focus Group Discussion}\marginnote{For now I have simply added a summary of the main points we extracted for each acculturation aspect. I assume that if we would like to keep this I will have to shorten this to a quote per aspect across one or two paragraphs. But we should first decide whether we would like to keep it.}
