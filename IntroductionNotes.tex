...
The focus group discussion, thus, laid the ground work for the development of our 
...
\subsection{Context Framework}\marginnote{Not sure how much we should shorten this. We could probably even drop it completely. Event though it would hurt.}
