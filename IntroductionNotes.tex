...
Link to inter-group and cultural contact:\marginnote{I don't exactly know why these last three paragraphs are missing (i.e., notes only). I will check where they went --- I hope they are still in some backup} motivation predicts behavior in general \citep{Kitayama2007} and intercultural conflict in particular \citep{Hassler2021, Shnabel2008a}
...
\newthought{Features} Unique selling points:\marginnote{Still needs to be done! Based on main and PowerPoint notes}\\
