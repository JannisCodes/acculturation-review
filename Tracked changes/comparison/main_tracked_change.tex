...
%DIF ADD main_rev.tex   Tue Apr  4 21:35:07 2023
...
%DIF 76a77-86
% SI labels %DIF > 
\newcommand{\sicodingmanual}{Supplemental Material A} %DIF > 
\newcommand{\siannotatedanalyses}{Supplemental Material B} %DIF > 
\newcommand{\sidirectory}{Supplemental Material C} %DIF > 
\newcommand{\sicontext}{Supplemental Material D} %DIF > 
 %DIF > 
...
% Past literature
Given the overt nature of behaviors and their interconnectedness with \DIFdelbegin \DIFdel{culture}\DIFdelend \DIFaddbegin \DIFadd{cultural patterns}\DIFaddend , behaviors have also been a prominent aspect \DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{in }\DIFaddend the acculturation literature. Ward and colleagues (\citeyear{Ward2019}) in their review have identified cultural learning theories as one key literature tradition that has focused on behavioral aspects of acculturation. They relate these learning theories to the acquisition of effective skills and competences as the behavioral operationalizations \citep[including, verbal and non-verbal communication skills][]{Ward2001}. Other examples of behavioral conceptualizations of acculturation (beyond Ward's focus), include civic participation \citep[e.g., voting;][]{Lessard-Phillips2020}, inter-ethnic marriage \citep[e.g.,][]{Song2009}, and media consumption \citep[e.g.,][]{Shoemaker1985}. 
...
% Past literature
Given the pertinent connection between \DIFdelbegin \DIFdel{cultures }\DIFdelend \DIFaddbegin \DIFadd{cultural patterns }\DIFaddend and cognitive processes, \DIFdelbegin \DIFdel{it might come as little surprise that }\DIFdelend cognitions have also played a major role in the \DIFaddbegin \DIFadd{theoretical }\DIFaddend acculturation literature. Within the cognitive tradition, Ward and colleagues (\citeyear{Ward2001, Ward2019}) have identified ethnic identity and group perception theories, with a particular focus on Berry's (\citeyear{Berry1997b}) acculturation attitudes. Beyond the theories identified by Ward, the acculturation literature has recently also focused on several other cognitive conceptualizations of psychological acculturation, including cultural values \citep[e.g.,][]{Marin2003} and stereotypes \citep[e.g.,][]{Stanciu2018}. 
...
\DIFaddend In sum, the conceptual framework \DIFdelbegin \DIFdel{we propose }\DIFdelend suggests that the concept of psychological acculturation is psychologically fundamentally structured into affect, behavior, cognition, and desire aspects. And while each experiential aspect \DIFdelbegin \DIFdel{captured }\DIFdelend \DIFaddbegin \DIFadd{captures }\DIFaddend part of the concept, only jointly will they comprehensively capture the full psychological acculturation concept. We have also shown that the four experience aspects are all highly relevant to the concept as they capture \DIFdelbegin \DIFdel{cultures, cross-cultural contact, and adaptation. The framework }\DIFdelend \DIFaddbegin \DIFadd{the dynamic, adaptive, and interactive functionings of contacts with new cultural patterns. We have further emphasized that the experience framework highlights the embedded complexities of real-world migration experiences and that the distinction of the ABCD structure along the dynamics of cultural contacts brings together several theoretical perspectives of the psychological acculturation literature. 
}
...
\begin{enumerate}[noitemsep,topsep=0pt,label=RQ \arabic*:,leftmargin=1.8cm]
    ...
    \item How is the cultural, individual, and \DIFdelbegin \DIFdel{situation }\DIFdelend \DIFaddbegin \DIFadd{situational }\DIFaddend context of psychological acculturation conceptualized and addressed in the past literature? [see \DIFdelbegin \DIFdel{Supplemental Information E}\DIFdelend \DIFaddbegin \DIFadd{\sicontext}\DIFaddend ]
\end{enumerate}

To address these research questions we, specifically chose a \textit{systematic scoping review}. Such a review is \textit{systematic} because it uses ``systematic and explicit methods to identify, select, and critically appraise relevant research, and to collect and analyze data from the studies" \citep[PRISMA guidelines; ][p. 1]{Moher2009}. In practice, this meant that we developed \DIFdelbegin \DIFdel{systematic a literature search }\DIFdelend \DIFaddbegin \DIFadd{literature search- }\DIFaddend and data extraction protocols for a structured, transparent, and reproducible review (for the systematic search protocol see \appref{app:AppendixSearchStrategy} and for our coding manual see \DIFdelbegin \DIFdel{Supplemental Material B}\DIFdelend \DIFaddbegin \DIFadd{\sicodingmanual}\DIFaddend ; also see \citealp{Peters2015}). To analyze and summarize the data we then perform a \textit{scoping analysis} to ``map the key concepts underpinning a research area and the main sources and types of evidence available" \citep[][p.21]{Arksey2005}. In our case, this meant that we were able to address our broader research questions of how psychological acculturation has been conceptualized within different bodies of past literature and how useful the ABCD separation was in assessing and comparing conceptualizations.
...
described in the coding manual (\DIFdelbegin \DIFdel{Supplemental Material B}\DIFdelend \DIFaddbegin \DIFadd{\sicodingmanual}\DIFaddend ), as part of the full
annotated analyses (\DIFdelbegin \DIFdel{Supplemental Material C}\DIFdelend \DIFaddbegin \DIFadd{\siannotatedanalyses}\DIFaddend ) as well as in our open science
repositories \citep[see][]{Kreienkamp2021d, Kreienkamp2021e}.
...
\DIFdelbegin \DIFdel{Supplemental Material C }\DIFdelend \DIFaddbegin \DIFadd{\sidirectory, }\DIFaddend as well as on our open science repository
...
investigations (such as grounded theory approaches; N = 17). \DIFaddbegin \DIFadd{A complete
and interactive list of the collected theoretical works, including
reference- and publication information, as well as our experience aspect
codings is available via our acculturation directory app, described in
\sidirectory.
}\DIFaddend 
...
\DIFdelbegin \DIFdel{Supplemental Material C}\DIFdelend \DIFaddbegin \DIFadd{\siannotatedanalyses}\DIFaddend ). We only coded explicit mentions by the authors
...
\DIFdelbegin \DIFdel{Supplemental Material B}\DIFdelend \DIFaddbegin \DIFadd{\sicodingmanual}\DIFaddend ).
...
-context coding is available in \DIFdelbegin \DIFdel{Supplemental Material D }\DIFdelend \DIFaddbegin \DIFadd{\sidirectory, }\DIFaddend (also see
\fgrref{fig:DirectoryScreen} for an illustration).

\begin{figure}[ht!]
  \centering
  \caption{Screenshot of the \DIFdelbeginFL \textit{\DIFdelFL{Acculturation Scale Directory}}%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \textit{\DIFaddFL{Acculturation Directory}}\DIFaddendFL . Top: Main table of the included acculturation scales as well as the filter interface. Bottom: Detailed view of selected scale with item, response, sample, and life domain information. A full description of the directory is available in \DIFdelbeginFL \DIFdelFL{Supplemental Material D }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{\sidirectory }\DIFaddendFL and the directory is available at: \DIFdelbeginFL \href{https://acculturation-review.shinyapps.io/scale-directory/}{\DIFdelFL{https://acculturation-review.shinyapps.io/scale-directory/}}%DIFAUXCMD
\DIFdelendFL \DIFaddbeginFL \href{https://acculturation-review.shinyapps.io/acculturation-directory/}{\DIFaddFL{https://acculturation-review.shinyapps.io/acculturation-directory/}}\DIFaddendFL .}
...
\DIFdelbegin \DIFdel{Supplemental Material E}\DIFdelend \DIFaddbegin \DIFadd{\sidirectory}\DIFaddend ). Additionally, scales were also either more focused on a
specific aspect \citep[e.g., `Asian Value Scale';][]{Kim1999, Kim2004a}
or aimed to capture acculturation more broadly
...
as they related to the \DIFdelbegin \DIFdel{dominant culture }\DIFdelend \DIFaddbegin \DIFadd{local }\DIFaddend and the heritage \DIFdelbegin \DIFdel{culture}\DIFdelend \DIFaddbegin \DIFadd{cultural patterns}\DIFaddend , we saw
a trend towards explicitly asking about different life domains
\DIFdelbegin %DIFDELCMD < \citep[e.g., family, work, media;][also see Supplemental Material E]{Kim2010a, Arends-Toth2007, Mancini2014}%%%
\DIFdelend \DIFaddbegin \citep[e.g., family, work, media;][also see \sicontext]{Kim2010a, Arends-Toth2007, Mancini2014}\DIFaddend .
...
\DIFdelbegin %DIFDELCMD < \citep[we followed the procedures outlined by][for a full methodological detail see Supplemental Material C]{Schweinberger2022}%%%
...
\DIFdelbegin %DIFDELCMD < \citep[ e.g., media consumption, among friends, at work][for more information see Supplemental Material C]{Birman2002}%%%
...
\DIFaddbegin \DIFadd{The same static reductionist practices hold true for the conceptualization of culture more broadly. While many theoretical conceptualizations of cultural patterns have pointed to the rich idiosyncrasies of cultural realities, more applied models and empirical studies often fail to capture the multifaceted, interactive, and fluid nature of the cultural patterns migrants (re-)create. Future studies should have a more transparent communication of the cultural patterns involved and more research is needed for contexts where new cultural patterns emerge or several cultural patterns come into conflict.
}

\DIFaddend A similar gap exists in the focus on specific aspects, where affect and desire conceptualizations are highlighted in theoretical works as well as \DIFdelbegin \DIFdel{our qualitative study }\DIFdelend \DIFaddbegin \DIFadd{more bottom-up qualitative studies }\DIFaddend but remain relatively absent in empirical quantitative works. Future empirical studies will thus need to investigate the mechanisms and roles of affective and motivational acculturation.
