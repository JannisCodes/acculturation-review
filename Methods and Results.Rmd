...
```{r EmpElementCooccurrences, include=F}
# make crossproduct matrix to condense co-occurrences (off-diagonals) and get frequencies (diagonals)
...
\vspace{1em}
\todo[inline]{Experience To Do: Co-occurrence numbers, percentage of concept in unique combinations. Which element is represented how much in each of the levels of complexity(k-way co-occurrences). Add figures or tables for frequencies}
