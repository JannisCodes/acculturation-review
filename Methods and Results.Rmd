...
\begin{itemize}
  \item behavior: language (often separated between at home and outside the home; in different facets of life, e.g., media consumption, among friends), food, ethnicity of people interacted with.
  \item cognition: identity
  \item affect: pride, discomfort
\end{itemize}
\color{black}
