...
```{r LiteratureComparison, include=F, fig.width=17, fig.height=17*1.414}
cowplot::plot_grid(CombinedABCDBar, CombinedComplexityBar, CombinedAspectComplexityMean, nrow=3, align = "v", rel_heights = c(1/3, 1/3, 1/3)) +
  draw_plot_label(c("(A)", "(B)", "(C)"), c(0.01, 0.01, 0.01), c(1, 2/3, 1/3), size = 18)
```
...
\begin{figure}[h]
\centering
\caption{Literature Levels: (A) Bar graph of the number of experience aspects used for theoretical, methodological, and broader empirical literature. (B) Average number of additional aspects included when the aspect was considered for theoretical, methodological, and broader empirical literature [Mean ± 95\%CI]. (C) Average number of additional aspects included when the aspect was considered for theoretical, methodological, and broader empirical literature [Mean ± 95\%CI].}
