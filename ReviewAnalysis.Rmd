...
The remaining `r nrow(dt.Scales[is.na(dt.Scales$Comment),])` scales are listed in Table \@ref(tab:ScaleTbl).  
...
data.frame(table(Exclusion = dt.psych$TitleNote)) %>%
  arrange(desc(Freq)) %>%
...
data.frame(table(Exclusion = dt.psych$AbstractNote)) %>%
  arrange(desc(Freq)) %>%
...
```{r descriptivs}
summarytools::freq(dt.psych.included$MeasurementLevels, order = "freq")

summarytools::freq(dt.psych.included$IncludesMajority, order = "freq")

summarytools::freq(dt.psych.included$VariableType, order = "freq")

summarytools::freq(dt.psych.included$Sample, order = "freq")

summarytools::freq(dt.psych.included$domainScale, order = "freq")

summarytools::freq(dt.psych.included$domainPaper, order = "freq")

summarytools::freq(dt.psych.included$MigrationTime, order = "freq")
```
...
save(dt.Scales, dt.Scales.Included, dt.psych, dt.psych.included, psychData, dt.Domains, dt.Theories, dt.Theories.Included, psychDataDisciplines, file = "data/wrangled.RData")
```
