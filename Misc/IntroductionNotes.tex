...
\newthought{Problem - Definitions}\label{sec:definition}The most widely reported definition of 'acculturation', as it is understood within the psychological tradition, is probably the definition by the Social Science Research Council \citep[][p. 149]{Redfield1936}:
\begin{quote}
...
\newthought{Problem - Past Conceptual Literature}
