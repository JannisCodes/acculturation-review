...
lib <- c("rmarkdown", "knitr", "citr", "remedy", "bookdown", "papaja", "rmdfiltr", "psych",
         ...
         "tibble", "sqldf", "networkD3", "GGally", "ggstatsplot","hrbrthemes", "patchwork",
...
### Time  
We also assessed when empirical works were published to gain a feel for a theoretical interest in the topic.  
...
ggExtra::ggMarginal(theoryYearCum, x = "Year", y="Freq", type = "histogram", margins = "x", alpha=1, fill="black", color="gray15") 
```
...
N items, N subscales, Response Range, Measurement Level, 
...
## Context
<!-- Or move this into descriptives -->
### Culture  
...
### Context 
cultures, individual (sample), situation (domain), process (migration time, analysis)   
...
save(dt.Scales, dt.Scales.Included, 
     ...
     dt.Domains, psychDataDisciplines, file = "data/wrangled.RData")
```
