---
title: "Supplemental Information C: Full Annotated Analysis and Reproducible Code"
...
\\def \\percTheoMissing {", percConceptualizations, "}",
    sep = "", 
    file = "Supplemental Material B - Coding Protocol/margins/theoNums.tex")
...
\\def \\percMethInaccess {", percMethInaccess, "}",
    sep = "", 
    file = "Supplemental Material B - Coding Protocol/margins/methNums.tex")
...
\\def \\percChapter {", percChapter, "}",
    sep = "", 
    file = "Supplemental Material B - Coding Protocol/margins/empNums.tex")

cat("\\def \\nTheo {",nTheo,"}
\\def \\nScales {",nScales,"}
\\def \\nEmp {", nEmp, "}",
    sep = "", 
    file = "Supplemental Material B - Coding Protocol/margins/nNums.tex")
```
