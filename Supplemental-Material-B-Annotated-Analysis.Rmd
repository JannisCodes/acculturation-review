...
# to store the packages in a contained library within the project folder: renv::settings$use.cache(FALSE)
# , "papaja", "citr"
...
lib <- c("rmarkdown", "knitr", "remedy", "bookdown", "rmdfiltr", "psych",
         ...
         "rworldmap", "rnaturalearth", "rnaturalearthdata", "rgeos", "sp", "ggspatial", "webshot2",
...
# render("Supplemental-Material-B-Annotated-Analysis.Rmd")
