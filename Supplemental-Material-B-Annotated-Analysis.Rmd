...
subtitle: "Suppplementary Information for 'The Migration Experience: A Conceptual Framework and Systematic Review of Psychological Acculturation'"
author:
- Jannis Kreienkamp^1^
- Laura Bringmann^1^
- Raili Engler^1^
...
lib <- c("rmarkdown", "knitr", "citr", "remedy", "bookdown", "papaja", "rmdfiltr", "psych",
         ...
         "DiagrammeR", "janitor", "DiagrammeRsvg", "rsvg", "manipulateWidget", "htmlwidgets", "webshot2")
...
empiricalDomainFreq %>%
  ...
  kbl(., 
        #label = "",
        caption = "Empirical Literature: <br>Live Domain Frequency",
        format = "html", 
        linesep = "",
        booktabs = T,
        align = c('l', rep('c', ncol(.)-1)))  %>%
...
```{r empiricalDomainFreqWordCloud, warning=F, fig.cap="Wordcloud of the life domains studied in empirical studies."}
# Word cloud frequencies
set.seed(7) # for reproducibility 
...
write.csv(theorySearchCleand,'data/OSF/theoretical01_SearchCleand.csv')
...
write.csv(dt.Scales.Included, 'data/OSF/methodological01_DatabaseCoded.csv')
...
write.csv(empiricalSearchCleand,'data/OSF/empirical01_SearchCleand.csv')
