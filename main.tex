...
We have no known conflict of interest to declare. Should include "study registration, open practices and data sharing" (APA 7, p. 36). So link to OSF and GitHub should be here as well (would include: materials, source data, and analysis data; APA 7, p. 13 f.)?
...
% Abstract
\abstract{
\Warning\ Needs to be updated!\\One of the key challenges to researching psychological acculturation is an immense heterogeneity in theories and measures. These inconsistencies make it difficult to compare past literature on acculturation, hinder straight-forward measurement selections, and hampers the development of an overarching framework. To structure our understanding of the migration process, we propose to utilize the four basic elements of human experiences (motivations, feelings, thoughts, and behaviors) as a conceptual framework. We use this framework to build a theory-driven literature synthesis and find that the past theoretical (final \textit{N} = 97), methodological (final \textit{N} = 244) and empirical literature (final \textit{N} = 674) have understudied the more internal aspects of acculturation (motivations and feelings) and have often fallen short of capturing all four aspects of the migration experience.
