...
\begin{enumerate}[noitemsep,topsep=0pt,label=RQ \arabic*:,leftmargin=1.8cm]
    ...
    \end{enumerate}
    \item What are the main differences in the conceptualizations of psychological acculturation experiences across the past theoretical, \textcolor{blue}{psychometric}, and empirical literature?
...
In the following section, we will briefly discuss how we conducted the systematic \textcolor{blue}{scoping} review and will sequentially analyze the role of experience aspects in the theoretical, \textcolor{blue}{psychometric}, and empirical literature of psychological psychological acculturation. \textcolor{blue}{Please note that all protocols, materials, data, and software code is openly accessible as part of our OSF repository \citep[][]{Kreienkamp2021e}.}
...
And secondly, we also applied the experience-based framework in a systematic \textcolor{blue}{scoping} review of past theoretical, \textcolor{blue}{psychometric}, and empirical literature on psychological acculturation.
\color{blue}
...
\begin{figure}
\centering
\caption{PRISMA Diagrams for the Theoretical, \textcolor{blue}{Psychometric}, and Empirical Literature.}
