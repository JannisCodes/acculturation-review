...
We have no known conflict of interest to declare. The authors received no specific funding for this work. Should include "study registration, open practices and data sharing" (APA 7, p. 36). So link to OSF and GitHub should be here as well (would include: materials, source data, and analysis data; APA 7, p. 13 f.)?
