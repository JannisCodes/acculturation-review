...
\todo[inline]{data description \\
To Do: fix table labels in R, Add summary stats in R}
...
\vspace{1em}
\todo[inline]{re-check `general' code}
...
\vspace{1em}
\todo[inline]{Paper domains need to be summarized (focused).}

% PRISMA chart goes somewhere here
\begin{figure}[h]
\centering
...
\vspace{1em}
\todo[inline]{re-check `general' category}
