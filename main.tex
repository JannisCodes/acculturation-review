...
\abstract{\todo[inline]{Needs to be done.} Abstract goes here.}
...
To assess the past psychological literature on cultural adaptation, we performed a systematic review. We 
...
Our search was loosely based on the SPIDER research tool \citet[e.g.,]{Cooke2012}. We utilized the \textit{Evaluation} element to mainly exclude articles that were not relevant to the search. The exact search terms used are listed in Table \ref{tab:SearchStrategiesTab}.
