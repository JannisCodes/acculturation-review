...
belong). This also meant that only about a tenth of the theories focused
on a single aspect (10.87\%). Interestingly, all theories that
considered only one aspect were exclusively focusing on behaviors (N =
7) or cognitions (N = 3). Of the remaining theories, 20 (21.74\%)
considered all four aspects, leaving a majority of theoretical works to
considered two (39.13\%) or three aspects (28.26\%). The most common
...
scales measure multiple dimensions (\textit{m} = 2.6087), yet they focus
on external accessible aspects of psychological acculturation (i.e.,
...
the observation that there were no theories that exclusively focused on
...
considered they were found in theories that tend to already include a
