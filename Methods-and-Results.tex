...
grounded theory and other bottom-up works. As an example,
...
down-stream adaptation processes. Similarly, in
\citet[]['s]{Mchitarjan2013} work, one key determinant of
``acculturation success or failure'' are ``motivational factors,
i.e.~the motives, desires, or goals of the minority and majority''.
