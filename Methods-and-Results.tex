...
\textbackslash subsection\{Compare Literature Levels {[}to be
incorporated with the overall conclusions{]}

Compare Theory - Scale - Application levels --- see Figures
\ref{fig:CombinedAspects}, \ref{fig:CombinedComplexity},
\ref{fig:CombinedComplexityAspects}.
...
\begin{figure}[h]
\centering
\caption{Literaure Levels: Bar graph showing the relative importance of the experience aspects within each of the complexity levels for theoretical, methodological, and broader empirical literature.}
\includegraphics[width=\textwidth]{Figures/CombinedComplexityBarAspects-1}
\label{fig:CombinedComplexityAspects}
\end{figure}
