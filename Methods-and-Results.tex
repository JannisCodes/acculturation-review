...
(\textit{m} = 2.61, '\textit{sd} = 0.90). Yet they tend to focus on more
...
\ref{fig:EmpPlotFreq-1} and Table \ref{tab:CombinedCooccurrences}).
...
aspects. Scales that included cognitions measured an average of 2.54
aspects, scales measuring behavior, on average, measured 2.43, while
scales that included affect measured an average of 2.93 experience
aspects and scales measuring desires even measured an average of 3.28
experience aspects. Thus, not a single study measured only motivation
(i.e., desires), and measures of desires remained mostly limited to
scales that were already measuring many of the other experience aspects.
...
and external aspects of cognition and behavior remain the focus of most
studies.
