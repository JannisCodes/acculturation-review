...
extraction is described in the online Supplemental Information B
(as well as on
...
exclusion reasons see Table \ref{tab:ExclusionsCombined} and for our
PRISMA diagram see Figure \ref{fig:PRISMA}).
...
B, Table \hl{X} for the missing journals). We ultimately had
...
we assessed differences of experience aspects between academic
