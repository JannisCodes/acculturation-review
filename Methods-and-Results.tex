...
\(\varkappa_{pooled}\) = ; for full inter-rater reliability see
...
examples can be found in Table \ref{tab:AspectExamples}.
...
aspects combined (16.3\%; also see Figure \ref{fig:ElementsTheories} and
Table \ref{tab:CombinedCooccurrences}).
