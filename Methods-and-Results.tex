...
\citep[i.e., conditions of stress; e.g.,][; also see \fgrref{fig:ModelContext} and Figure S1 in Supplemental Material C]{Ryan2008, Berry1992, Benet-Martinez2005, Salo2015, Wood2014, Hajro2019}.
...
\tblref{tab:ExclusionsCombined} and for the PRISMA diagram see
\fgrref[ C]{fig:PrismaCombined}).
...
\tblref{tab:AspectExamples}). The only exception were qualitative
...
\fgrref{fig:EmpPlotFreq-1} and \tblref{tab:CombinedCooccurrences}).
