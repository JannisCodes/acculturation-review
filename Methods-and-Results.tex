...
responses, and (3) acculturation outcomes. This is to say that
theoretical works have, generally speaking, focused on the
socio-structural and personal background of the acculturation experience
...
\citep[i.e., response; e.g.,][]{Berry1992, Berry2005, Sam2003, Reidel2011, Ward2016}
or on the psychological and sociocultural consequences of the contact
\citep[i.e., outcome; e.g.,][]{Baird2015, Berry1998, Berry1992, Berry2005, Riedel2011, Rogler1994, Luedicke2011}.
Within our proposed ABCD framework, these three steps describe the
...
conditions lead to changes in the acculturation responses
\citep[i.e., conditions of change; e.g.,][]{Masgoret2006, Alitolppa-Niitamo2004, Grove1985, Wood2014},
and under which conditions acculturation responses lead to stressful or
adaptative accultuation responses
...
This approach builds on previous step-wise conceptualizations
\citep[e.g., process vs. outcome distinction][]{Sam2006b} and models of
acculturation \citep[e.g.,][]{Arends-Toth2006a, TeLindert2008a}.
Alternative labels of the three stages would be ``Immersion, Processing,
Change'', or ``Evaluation, Negotiation, Navigation''to reflect some of
the other theories that have proposed step-wise appoaches
\citep[e.g.,][]{Cross1991, Atkinson1993, Gordon1964a}.
...
authors tended to discuss

Examples:

Robinson2019: clear mentions values, beliefs, behaviors (VBBs)
Bhawuk2006: calling for ``affective, behavioral and behavioral training
approaches'' to intercultural trainings \citep[][Table 30.3]{Bhawuk2006}

Berry1992: clear mentions.\\
We find an example of this explicitness in the classic work of
...
Kim1988: ``Integrative Theory of Communication and Cross-Cultural
Adaptation'' Explicit theorizing (boundary conditions, specifying the
term {[}cross-cultural adaptation{]}, theory-building: assumptions,
axioms, theorems; as well as embedding in broader metatheoretical works,
e.g., General Systems Theory). ABC: ``a number of cognitive, affective
and behavioral elements of host communication competence are presented
for their direct relevance to the present theoretical concern,
