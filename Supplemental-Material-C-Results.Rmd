...
scalesDomainUniqueComb <- sum(scalesDomainCombFreq$Percentage[scalesDomainCombFreq$Frequency==1])
scalesDomainLess5 <- sum(scalesDomainCombFreq$Percentage[scalesDomainCombFreq$Percentage<5])
